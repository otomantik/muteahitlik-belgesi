      ...
      <div className="container mx-auto px-4 h-full flex items-center justify-between">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-accent-dark rounded-sm flex items-center justify-center">
              <span className="text-white font-bold text-sm">MB</span>
            </div>
            <span className="text-foreground font-semibold text-lg hidden md:inline">
              Müteahhitlik Belgesi
            </span>
          </Link>
          
          {/* Working Hours - Mobile */}
          <div className="ml-4 text-sm text-muted-foreground md:hidden">
            <span className="hidden sm:inline">{HOURS.description}</span>
          </div>
        </div>
